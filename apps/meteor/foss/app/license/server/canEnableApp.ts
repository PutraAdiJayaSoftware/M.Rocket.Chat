...
export const _canEnableApp = async ({ Apps }: _canEnableAppDependencies, app: IAppStorageItem): Promise<void> => {
...
export const canEnableApp = async (app: IAppStorageItem): Promise<void> => _canEnableApp({ Apps }, app);
